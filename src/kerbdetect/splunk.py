...
from kerbdetect.schema import SOURCETYPES

DEFAULT_REST_URL = "https://localhost:8089"
DEFAULT_HEC_URL = "https://localhost:8088"
DEFAULT_USER = "admin"
DEFAULT_PASSWORD = "kerbdetect_dev_2026"  # noqa: S105  # nosec B105
DEFAULT_INDEX = "kerbdetect"

ENV_REST_URL = "KD_SPLUNK_URL"
ENV_HEC_URL = "KD_SPLUNK_HEC_URL"
ENV_USER = "KD_SPLUNK_USER"
ENV_PASSWORD = "KD_SPLUNK_PASSWORD"  # noqa: S105  # nosec B105
ENV_INDEX = "KD_SPLUNK_INDEX"
...
class SplunkClient:
    ...
    def count_events(self, run_tag: str) -> int:
        rows = self.oneshot_search(
            f'index={self.config.index} kd_run="{run_tag}" | stats count as count'
        )
        if not rows:
            return 0
